...
function getBotResponse(input) {
    ...
    //NRS
      ...
      return 'Heyyy, ta falando com a IA certa! Qual Norma Regulamentadora quer consultar?📚';
    } else if (input == 'nr 01') {
      ...
      return 'Norma Regulamentadora nr.º 02 – Inspeção Prévia Revogada';
    } else if (input == 'nr02') {
      return 'Norma Regulamentadora nr.º 02 – Inspeção Prévia Revogada';
    } else if (input == 'nr 2') {
      return 'Norma Regulamentadora nr.º 02 – Inspeção Prévia Revogada';
      ...
      return 'Norma Regulamentadora nr.º 03 – Embargo ou Interdição Trata-se de medidas de urgência, adotadas a partir da constatação de situação de trabalho que possa causar acidente ou doença eminente com lesão grave à integridade física do trabalhador.A interdição implica a paralisação total ou parcial do estabelecimento, setor de serviço, máquina ou equipamento, e, o embargo, a paralisação total ou parcial da obra.';
    } else if (input == 'nr03') {
      return 'Norma Regulamentadora nr.º 03 – Embargo ou Interdição Trata-se de medidas de urgência, adotadas a partir da constatação de situação de trabalho que possa causar acidente ou doença eminente com lesão grave à integridade física do trabalhador.A interdição implica a paralisação total ou parcial do estabelecimento, setor de serviço, máquina ou equipamento, e, o embargo, a paralisação total ou parcial da obra.';
    } else if (input == 'nr 3') {
      return 'Norma Regulamentadora nr.º 03 – Embargo ou Interdição Trata-se de medidas de urgência, adotadas a partir da constatação de situação de trabalho que possa causar acidente ou doença eminente com lesão grave à integridade física do trabalhador.A interdição implica a paralisação total ou parcial do estabelecimento, setor de serviço, máquina ou equipamento, e, o embargo, a paralisação total ou parcial da obra.';
      ...
      return '📣ATENÇÃO EM NOVEMBRO DE 2022 MUDANÇAS POR AQUI Trata-se do SESMT (Serviços Especializados em Engenharia de Segurança e em Medicina do Trabalho), que orienta quais e quantos profissionais voltados a Saúde e Segurança do trabalho estão escalados na empresa em questão, garantindo a aplicação de conhecimentos técnicos de engenharia de segurança e de medicina ocupacional no ambiente de trabalho, reduzindo ou até eliminando riscos à saúde dos trabalhadores. Para mais informações, recomendo você a baixar o aplicativo App NR disponivel na Play Store';
    } else if (input == 'nr04') {
      return '📣ATENÇÃO EM NOVEMBRO DE 2022 MUDANÇAS POR AQUI Trata-se do SESMT (Serviços Especializados em Engenharia de Segurança e em Medicina do Trabalho), que orienta quais e quantos profissionais voltados a Saúde e Segurança do trabalho estão escalados na empresa em questão, garantindo a aplicação de conhecimentos técnicos de engenharia de segurança e de medicina ocupacional no ambiente de trabalho, reduzindo ou até eliminando riscos à saúde dos trabalhadores. Para mais informações, recomendo você a baixar o aplicativo App NR disponivel na Play Store';
    } else if (input == 'nr 4') {
      return '📣ATENÇÃO EM NOVEMBRO DE 2022 MUDANÇAS POR AQUI Trata-se do SESMT (Serviços Especializados em Engenharia de Segurança e em Medicina do Trabalho), que orienta quais e quantos profissionais voltados a Saúde e Segurança do trabalho estão escalados na empresa em questão, garantindo a aplicação de conhecimentos técnicos de engenharia de segurança e de medicina ocupacional no ambiente de trabalho, reduzindo ou até eliminando riscos à saúde dos trabalhadores. Para mais informações, recomendo você a baixar o aplicativo App NR disponivel na Play Store';
    ...
    } else if (input == 'o que significa pgr') {
      return 'E lá vamos nós... para mais uma sigla! PGR Programa de Gerenciamento de Risco';
    ...
    //PPP
      ...
      return 'O Perfil Profissiográfico Previdenciário é o documento histórico-laboral do trabalhador que presta atividades especiais. Ou seja, ele descreve a história de trabalho do segurado na respectiva empresa e reúne informações das condições do empregado.';
    } else if (input == 'significado ppp') {
      return 'O Perfil Profissiográfico Previdenciário é o documento histórico-laboral do trabalhador que presta atividades especiais. Ou seja, ele descreve a história de trabalho do segurado na respectiva empresa e reúne informações das condições do empregado.';
    } else if (input == 'o que significa ppp') {
      return 'O Perfil Profissiográfico Previdenciário é o documento histórico-laboral do trabalhador que presta atividades especiais. Ou seja, ele descreve a história de trabalho do segurado na respectiva empresa e reúne informações das condições do empregado.';
    }

    //PPRA
    else if (input == 'ppra') {
      return 'O PPRA, Programa de Prevenção de Riscos Ambientais, tem por objetivo estabelecer medidas que visem a eliminação, redução ou controle desses riscos em prol da preservação da integridade física e mental do trabalhador. Vale LEMBRAR que o PGR substituiu o Programa de Prevenção de Riscos Ambientais (PPRA) a partir de agosto de 2021. Portanto, devemos promover a migração para o PGR.';
    } else if (input == 'significado ppra') {
      return 'O PPRA, Programa de Prevenção de Riscos Ambientais, tem por objetivo estabelecer medidas que visem a eliminação, redução ou controle desses riscos em prol da preservação da integridade física e mental do trabalhador. Vale LEMBRAR que o PGR substituiu o Programa de Prevenção de Riscos Ambientais (PPRA) a partir de agosto de 2021. Portanto, devemos promover a migração para o PGR.';
    } else if (input == 'o que significa ppra') {
      return 'O PPRA, Programa de Prevenção de Riscos Ambientais, tem por objetivo estabelecer medidas que visem a eliminação, redução ou controle desses riscos em prol da preservação da integridade física e mental do trabalhador. Vale LEMBRAR que o PGR substituiu o Programa de Prevenção de Riscos Ambientais (PPRA) a partir de agosto de 2021. Portanto, devemos promover a migração para o PGR.';
    }

    //PCMSO
    else if (input == 'pcmso') {
      return 'Como agente ama uma sigla né o PCMSO é: Programa de Controle Médico de Saúde Ocupacional 👨‍⚕️';
    } else if (input == 'o que significa pcmso') {
      return 'Como agente ama uma sigla né o PCMSO é: Programa de Controle Médico de Saúde Ocupacional 👨‍⚕️';
    } else if (input == 'o que é pcmso') {
      return 'O Programa de Controle Médico de Saúde Ocupacional é um programa obrigatório estabelecido pelo Ministério do Trabalho. Faz parte das iniciativas para promover a saúde dos trabalhadores. Este programa tem como objetivo estabelecer a realização de exames médicos admissionais, periódicos, retorno ao trabalho, mudança de função e demissional. Vamos de Dica :) quer saber mais sobre esse importante programa consulte NR 07 ela é totalmente voltada para esse programa!';
    } else if (input == 'para que serve pcmso') {
      return 'O Programa de Controle Médico de Saúde Ocupacional é um programa obrigatório estabelecido pelo Ministério do Trabalho. Faz parte das iniciativas para promover a saúde dos trabalhadores. Este programa tem como objetivo estabelecer a realização de exames médicos admissionais, periódicos, retorno ao trabalho, mudança de função e demissional. Vamos de Dica :) quer saber mais sobre esse importante programa consulte NR 07 ela é totalmente voltada para esse programa!';
    } else if (input == 'exames pcmso') {
      return 'Agora: Admissional, Periódico, Retorno ao Trabalho, Mudança de Risco Ocupacional e Demissional';
    } else if (input == 'quais exames pcmso') {
      return 'Agora: Admissional, Periódico, Retorno ao Trabalho, Mudança de Risco Ocupacional e Demissional';
    } else if (input == 'quais os exames do pcmso') {
      return 'Agora: Admissional, Periódico, Retorno ao Trabalho, Mudança de Risco Ocupacional e Demissional';
    } else if (input == 'quais os exames pcmso') {
      return 'Agora: Admissional, Periódico, Retorno ao Trabalho, Mudança de Risco Ocupacional e Demissional';
    } else if (input == 'preciso ter o pcmso') {
      return 'Simmmmmm! O programa é obrigatório para todas as empresas, em qualquer ramo de atividade, com qualquer número de empregados.';
    } else if (input == 'minha empresa precisa ter pcmso') {
      return 'Simmmmmm! O programa é obrigatório para todas as empresas, em qualquer ramo de atividade, com qualquer número de empregados.';
    }

    //LTCAT
    else if (input == 'ltcat') {
      return 'Bora lá para mais uma sigla?! O Laudo Técnico das Condições do Ambiente de Trabalho (LTCAT) é um documento do INSS para comprovação da exposição aos agentes ambientais nocivos à saúde ou à integridade física do trabalhador.';
    } else if (input == 'o que significa ltcat') {
      return 'Bora lá para mais uma sigla?! O Laudo Técnico das Condições do Ambiente de Trabalho (LTCAT) é um documento do INSS para comprovação da exposição aos agentes ambientais nocivos à saúde ou à integridade física do trabalhador.';
    } else if (input == 'qual o significado de ltcat') {
      return 'Bora lá para mais uma sigla?! O Laudo Técnico das Condições do Ambiente de Trabalho (LTCAT) é um documento do INSS para comprovação da exposição aos agentes ambientais nocivos à saúde ou à integridade física do trabalhador.';
    } else if (input == 'para que serve ltcat') {
      return 'Bora lá para mais uma sigla?! O Laudo Técnico das Condições do Ambiente de Trabalho (LTCAT) é um documento do INSS para comprovação da exposição aos agentes ambientais nocivos à saúde ou à integridade física do trabalhador.';
    } else if (input == 'quando é necessário fazer o ltcat') {
      return 'O LTCAT precisa ser elaborado quando existem atividades que expõem o trabalhador a agentes nocivos.';
    } else if (input == 'quando fazer o ltcat') {
      return 'O LTCAT precisa ser elaborado quando existem atividades que expõem o trabalhador a agentes nocivos.';
    } else if (input == 'validade ltcat') {
      return 'A validade é indeterminada, mas o ideal é que seja atualizado uma vez ao ano ou quando ocorrer alterações no ambiente de trabalho ou em sua organização';
    } else if (input == 'validade do ltcat') {
      return 'A validade é indeterminada, mas o ideal é que seja atualizado uma vez ao ano ou quando ocorrer alterações no ambiente de trabalho ou em sua organização';
    } else if (input == 'quanto tempo devo guardar o ltcat') {
      return 'Após a atualização, a empresa deve manter o LTCAT arquivado por 20 anos. Nesse período, auditores da Previdência Social podem fazer vistorias nas instalações da corporação. O período para armazenamento obrigatório é longo justamente por causa de sua relação com as solicitações de aposentadorias.';
    }
    ...
    //EPI
      ...
      return 'O CA é o Certificado de Aprovação dos EPIs.';
    } else if (input == 'o que é ca') {
      return 'O CA é o Certificado de Aprovação dos EPIs.';
    } else if (input == 'para que serve o ca') {
      return 'É um documento, emitido pelo Ministério da Economia, estabelecendo o prazo de validade para comercializar um determinado EPI. Quando falamos em comercialização, estamos falando tanto do fabricante ou importador, quanto das revendas de EPIs ou distribuidor de EPI. Isso  garante aos compradores a certeza de um EPI com garantia e dentro das normas legais. Não esqueçam antes de adquirir qualquer EPI consulte o CA!';
    } else if (input == 'onde consultar o ca') {
      return 'Aqui você pode fazer a sua consulta, divirta-se :) https://consultaca.com';
    }
